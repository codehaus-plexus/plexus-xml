 ...
 * <p>
 * <b>PLEASE NOTE:</b> This interface will be part of XmlPull 1.2 API. It is included as basis for discussion. It may
 * change in any way.
 * <p>
 ...
 * <li><em>IllegalStateException</em> - to signal that call has good arguments but is not expected here (violation of
 ...
 * </ul>
 * <p>
 * <b>NOTE:</b> writing CDSECT, ENTITY_REF, IGNORABLE_WHITESPACE, PROCESSING_INSTRUCTION, COMMENT, and DOCDECL in some
...
public interface XmlSerializer {
     ...
     * attribute()) - for XML 1.0 it must result in declaring <code>xmlns:prefix='namespace'</code> (or
     * <code>xmlns:prefix="namespace"</code> depending what character is used to quote attribute value).
     * <p>
     * <b>NOTE:</b> this method MUST be called directly before startTag() and if anything but startTag() or setPrefix()
     * is called next there will be exception.
     * <p>
     * <b>NOTE:</b> prefixes "xml" and "xmlns" are already bound and can not be redefined see:
